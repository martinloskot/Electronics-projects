...
<p align="center">
```
`<img src="fotky/P%C5%99edn%C3%AD%20strana.png" width="70%" alt="Přední strana"/>`{=html}`<br/>`{=html}
...
<p align="center">
```
`<img src="fotky/Osazen%C3%AD%20sk%C5%99%C3%ADn%C4%9B.png" width="70%" alt="Osazení skříně"/>`{=html}`<br/>`{=html}
...
<p align="center">
```
`<img src="fotky/Zadn%C3%AD%20strana.png" width="70%" alt="Zadní strana"/>`{=html}`<br/>`{=html}
...
<p align="center">
```
`<img src="PCB/Vstupn%C3%AD%20zesilov%C3%A1%C4%8D/P%C5%99%C3%ADstrojov%C3%BD%20zesilov%C3%A1%C4%8D%20PCB.svg" width="70%" alt="PCB – Vstupní zesilovač"/>`{=html}`<br/>`{=html}
`<em>`{=html}Vstupní zesilovač`</em>`{=html}
```{=html}
</p>
```
...
<p align="center">
```
`<img src="PCB/ADC/ADC%20PCB.svg" width="70%" alt="PCB – ADC"/>`{=html}`<br/>`{=html}
`<em>`{=html}Analogově-digitální převodník`</em>`{=html}
```{=html}
</p>
```
...
<p align="center">
```
`<img src="PCB/Nap%C4%9B%C5%A5ov%C3%A1%20reference/Nap%C4%9B%C5%A5ov%C3%A1%20reference%20PCB.svg" width="70%" alt="PCB – Napěťová reference"/>`{=html}`<br/>`{=html}
`<em>`{=html}Napěťová reference`</em>`{=html}
```{=html}
</p>
```
...
<p align="center">
```
`<img src="PCB/%C5%98%C3%ADdic%C3%AD%20mikrokontroler/%C5%98%C3%ADdic%C3%AD%20mikrokontrol%C3%A9r%20PCB.svg" width="70%" alt="PCB – Řídicí mikrokontrolér"/>`{=html}`<br/>`{=html}
`<em>`{=html}Řídicí mikrokontrolér`</em>`{=html}
```{=html}
</p>
```
...
<p align="center">
```
`<img src="PCB/Nap%C3%A1jec%C3%AD%20zdroj/Nap%C3%A1jec%C3%AD%20zdroj%20PCB.svg" width="70%" alt="PCB – Napájecí zdroj"/>`{=html}`<br/>`{=html}
`<em>`{=html}Napájecí zdroj`</em>`{=html}
```{=html}
</p>
```
